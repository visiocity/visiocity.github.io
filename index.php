...
<body width="device-width">
  ...
  <div class="container">
    ...
    <p class="lead center-container">A New
      Benchmark and Evaluation Framework</p>
  </div>
  ...
  <div id="overview" class="container">
    ...
    <p> Automatic video summarization is still an unsolved problem due to several challenges. Lack of a <b>challenging
      ...
      flavors of
      video summarization and other vision problems like captioning as well. More details about VISIOCITY can be found in the paper <a href="https://arxiv.org/abs/2101.10514">here</a>.
      <br> <br>
      <div class="row">
  ...
  <div id="videos" class="container">
    ...
    <p> VISIOCITY contains publicly available Soccer, Friends, Techtalk, Birthday and Wedding videos downloaded from the
      internet.
      <ul>
